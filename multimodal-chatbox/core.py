...
from utils.faiss_io import read_faiss_index
...
# ``utf-8-sig`` reads regular UTF-8 files as usual and also strips the BOM
# that Windows editors may add before the first environment-variable name.
