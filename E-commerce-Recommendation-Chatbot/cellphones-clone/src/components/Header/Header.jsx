  ...
  return (
    <header className="main-header">
      <div className="container header-inner">
        ...
        <div className="header-category-wrapper">
          <button
            ...
            className={`header-outlined-btn ${
              activePopup === "category" ? "active-popup-btn" : ""
            }`}
        ...
        <button
          type="button"
          className={`header-outlined-btn header-location-btn ${
            activePopup === "location" ? "active-popup-btn" : ""
          }`}
          onClick={(event) => {
            event.stopPropagation();
        ...
        <div className="header-actions">
          ...
          <button
            ...
            className={`header-outlined-btn header-login-btn ${
              activePopup === "auth" ? "active-popup-btn" : ""
            }`}
            id="header-login-btn"
            onClick={(event) => {
              event.stopPropagation();
